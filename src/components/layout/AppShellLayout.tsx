import { AppShell, Box, Burger, Button, Divider, Group, Header, MediaQuery, Navbar, ThemeIcon, useMantineTheme, Text, useMantineColorScheme } from "@mantine/core"
                                ...
                                <Box>
                                    ...
                                    <MediaQuery smallerThan="md" styles={{ display: 'none' }}>
                                        ...
                                        >
                                            ...
                                            <TopBarNavLink to="https://github.com/rpetre/captains-toolkit/issues" label="Bugs & Issues" icon="bug" />
                                            <ColorSchemeToggle />
                                        </Group>
                                    </MediaQuery>
